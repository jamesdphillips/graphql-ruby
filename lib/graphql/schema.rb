...
class GraphQL::Schema
  ...
  attr_accessor :query_execution_strategy, :mutation_execution_strategy, :subscription_execution_strategy
  ...
  # @param subscription [GraphQL::ObjectType, nil] the subscription root for the schema
